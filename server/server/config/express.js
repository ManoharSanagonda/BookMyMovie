...
global.ordersList = {};
global.lastTradePriceObj = {};
global.logger = winstonInstance;
global.currenciesLimits = {};
global.lastTradeBuxPrice;
global.settings = {};
const app = express();
...
if (settings.enableTerminalLogs) {
...
app.get('', (req, res) => {
  res.send(`You are not allowed to perform opeartion`);
});
app.get('', (req, res) => {
...
app.use((err, req, res, next) => {
  ...
  //      errorCode: "9003",
  //      errMessage: "Error has occured please contact btrade support"
  //    });
